...
function TemplatePreview({
  ...
  if (layout === 'two-col') {
    return (
      <div className="w-36 h-48 bg-white rounded-lg shadow-xl flex flex-row overflow-hidden transform group-hover:scale-105 transition-transform duration-500">
        <div
          className={`w-[38%] bg-gradient-to-b ${gradient} p-2 flex flex-col gap-1.5`}
        >
  ...
  return (
    <div className="w-36 h-48 bg-white rounded-lg shadow-xl flex flex-col overflow-hidden transform group-hover:scale-105 transition-transform duration-500">
      <div
        className={`h-10 bg-gradient-to-r ${gradient} flex items-end px-3 pb-1.5`}
      >
      ...
      <main className="flex-1 max-w-6xl mx-auto w-full px-6 py-12">
        <div className="text-center mb-14 animate-fade-in-up">
          ...
          <p className="text-base text-slate-500 max-w-xl mx-auto leading-relaxed">
            Every template is ATS-optimized, LaTeX-powered, and used by
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {TEMPLATES.map((template, i) => (
            ...
            >
              ...
              <div
                className={`h-56 bg-gradient-to-br ${template.gradient} relative overflow-hidden flex items-center justify-center`}
              >
